...
export default function LandingPage() {
  return (
    <div className="space-y-12 pb-12 w-full">
      {/* Hero Section */}
      <section className="relative rounded-3xl bg-gradient-to-br from-[#18191d] via-[#111215] to-[#0a0a0c] border border-[#272930] p-8 lg:p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link
              to="/catalog"
              className="px-6 py-3.5 rounded-xl bg-[#22c55e] hover:bg-[#16a34a] text-slate-950 font-extrabold text-sm shadow-xl shadow-emerald-500/20 transition flex items-center gap-2 active:scale-95"
            >
              Khám Phá Danh Mục Thước <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              to="/custom"
              className="px-6 py-3.5 rounded-xl bg-[#1e2025] hover:bg-[#272930] text-slate-200 font-bold text-sm border border-[#272930] transition flex items-center gap-2"
            >
        ...
        {/* Floating Stats */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-10 pt-8 border-t border-[#272930]/80">
          <div className="p-3.5 rounded-xl bg-[#111215]/80 border border-[#272930]">
            <p className="text-2xl font-black text-white">15,000+</p>
            <p className="text-xs text-[#94a3b8]">Đơn thước in thành công</p>
          </div>
          <div className="p-3.5 rounded-xl bg-[#111215]/80 border border-[#272930]">
            <p className="text-2xl font-black text-[#22c55e]">0.12mm</p>
            <p className="text-xs text-[#94a3b8]">Độ mịn lớp in FDM</p>
          </div>
          <div className="p-3.5 rounded-xl bg-[#111215]/80 border border-[#272930]">
            <p className="text-2xl font-black text-white">48+ Máy</p>
            <p className="text-xs text-[#94a3b8]">Công suất máy in SLA/FDM</p>
          </div>
          <div className="p-3.5 rounded-xl bg-[#111215]/80 border border-[#272930]">
            <p className="text-2xl font-black text-cyan-400">100%</p>
            <p className="text-xs text-[#94a3b8]">Bảo hành 1 học kỳ</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-[#18191d] border border-[#272930] hover:border-[#22c55e]/50 transition group space-y-4">
      ...
      {/* Guarantee Section */}
      <section className="p-6 rounded-2xl bg-[#18191d] border border-emerald-800/40 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-[#22c55e]/15 border border-[#22c55e]/40 flex items-center justify-center text-[#22c55e] shrink-0">
        ...
        <Link
          to="/warranty"
          className="px-5 py-2.5 rounded-xl bg-[#22c55e] hover:bg-[#16a34a] text-slate-950 font-bold text-xs whitespace-nowrap transition"
        >
