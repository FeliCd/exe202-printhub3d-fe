    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-surface border border-border space-y-2">
          ...
          <span className="text-xs text-cyan-400 font-bold">14 xưởng in đang hoạt động</span>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-surface border border-border space-y-2">
          ...
          <span className="text-xs text-purple-400 font-bold">38 / 42 máy in đang chạy</span>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-surface border border-border space-y-2">
          ...
          <span className="text-xs text-red-400 font-bold">Cần quyết định bồi hoàn</span>
        </div>
      </div>
            ...
            {[
              ...
              <div key={i} className="py-3 flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-text-muted">Mã đơn: <span className="font-mono text-[#22c55e]">{j.id}</span> • Xưởng: {j.factory}</p>
                </div>
        ...
        <div className="p-5 rounded-2xl bg-surface border border-border space-y-3">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="p-3 rounded-xl bg-red-950/40 border border-red-800/40 text-red-300">
              ...
              <p className="text-sm opacity-80 mt-0.5">Yêu cầu bảo trì thay khay nhựa chứa UV resin.</p>
            </div>
          </div>
        </div>
      </div>
