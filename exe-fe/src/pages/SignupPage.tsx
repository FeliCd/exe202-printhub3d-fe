    ...
    <div className="min-h-[75vh] flex items-center justify-center w-full py-6">
      <div className="w-full max-w-lg p-6 sm:p-8 rounded-3xl bg-[#18191d] border border-[#272930] shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-[#94a3b8]">Nhận ngay Voucher Tân Sinh Viên 15.000đ &amp; Khắc MSSV miễn phí</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-300">Email trường học / Email cá nhân</label>
            <div className="relative">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-300">Mã số sinh viên (MSSV)</label>
              <input
                type="text"
                required
                value={studentId}
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-300">Trường Đại học</label>
              <div className="relative">
                <School className="w-4 h-4 absolute left-3 top-3 text-[#94a3b8]" />
                <input
                  type="text"
                  value={university}
