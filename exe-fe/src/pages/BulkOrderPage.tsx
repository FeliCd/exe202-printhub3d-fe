...
import { Upload, Layers, CheckCircle2, FileText, Trash2, ArrowRight } from 'lucide-react';
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-2xl bg-surface border border-border space-y-4">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-purple-600 hover:bg-purple-500 disabled:opacity-50 text-white font-black text-sm shadow-xl shadow-purple-950/50 transition flex items-center justify-center gap-2"
              >
