...
export default function WalletPage() {
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      {/* Balance Card */}
      <div className="p-6 rounded-3xl bg-gradient-to-br from-[#18191d] via-[#111215] to-[#1e2025] border border-[#272930] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shadow-xl">
        ...
        <button
          ...
          className="px-6 py-3.5 rounded-2xl bg-[#22c55e] hover:bg-[#16a34a] text-slate-950 font-black text-sm shadow-xl shadow-emerald-500/20 active:scale-95 transition flex items-center gap-2"
        >
      ...
      <div className="p-6 rounded-2xl bg-[#18191d] border border-[#272930] space-y-4">
            ...
            <div key={t.id} className="py-3.5 flex items-center justify-between gap-3 text-xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#94a3b8]">{t.date} • Mã GD: {t.id}</p>
                </div>
              </div>
              ...
              <div className="text-right">
                ...
                <span className="text-[9px] font-bold text-emerald-400 uppercase">Thành công</span>
              </div>
            </div>
          ))}
        </div>
      ...
      {depositModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-[#18191d] border border-[#272930] rounded-2xl p-6 space-y-5 text-left">
            ...
            <form onSubmit={handleDepositInitiate} className="space-y-4 text-xs">
                    ...
                    <button
                      ...
                      className={`p-2.5 rounded-xl border font-bold transition ${
                        depositAmount === amt
                          ...
                          : 'border-[#272930] bg-[#111215] text-slate-300'
                      }`}
                    >
                      {formatPrice(amt)}đ
                    </button>
              ...
              <div className="p-3 bg-[#111215] border border-[#272930] rounded-xl text-center space-y-1">
                ...
                <p className="text-[10px] text-[#94a3b8]">Nạp tự động không mất phí giao dịch</p>
              </div>

              <button
                type="submit"
                className="w-full py-3 rounded-xl bg-[#22c55e] hover:bg-[#16a34a] text-slate-950 font-bold text-xs"
              >
