    ...
    <div className="space-y-6 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 rounded-2xl bg-surface border border-border space-y-1">
          <p className="text-sm text-text-muted">Tổng Giờ Chạy Cụm Máy In</p>
          <p className="text-2xl font-black text-cyan-400">1,958.7 giờ</p>
          <span className="text-xs text-emerald-400 font-bold">Hiệu suất 94.2%</span>
        </div>

        <div className="p-4 rounded-2xl bg-surface border border-border space-y-1">
          <p className="text-sm text-text-muted">Lịch Thay Nozzle Sắp Tới</p>
          <p className="text-2xl font-black text-amber-400">1 Máy</p>
          <span className="text-xs text-amber-400 font-bold">Bambu Lab #02 (&gt;650h)</span>
        </div>

        <div className="p-4 rounded-2xl bg-surface border border-border space-y-1">
          <p className="text-sm text-text-muted">Sự Cố Cần Xử Lý</p>
          <p className="text-2xl font-black text-red-400">1 Máy</p>
          <span className="text-xs text-red-400 font-bold">Ender 3 kẹt nhựa PTFE</span>
        </div>
      </div>
      ...
      <div className="p-5 rounded-2xl bg-surface border border-border space-y-4">
        ...
        <div className="space-y-3">
          {logs.map(log => (
            <div key={log.id} className="p-4 rounded-xl bg-surface-inset border border-border text-xs space-y-3">
              ...
              <div className="flex flex-wrap items-center justify-between text-text-muted text-xs gap-2">
