  ...
  return (
    ...
    >
      <div className="p-4 space-y-6 overflow-y-auto flex-1">
        ...
        {/* ========================================================================= */}
        {/* GROUP 1: MUA SẮM & DỊCH VỤ (DROPDOWN) */}
        {/* ========================================================================= */}
        <nav className="pt-2 border-t border-[#272930]">
          <button
            type="button"
            onClick={() => setOpenShopping((prev) => !prev)}
            className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-black uppercase tracking-widest text-[#39FF14] hover:bg-[#18191d] transition cursor-pointer"
          >
            <span>🛍️ MUA SẮM &amp; DỊCH VỤ</span>
            <ChevronDown
              className={`w-4 h-4 text-[#39FF14] transition-transform duration-200 ${
                openShopping ? 'rotate-180' : ''
              }`}
            />
          </button>
        ...
        {/* ========================================================================= */}
        {/* GROUP 2: QUẢN LÝ GIAO DỊCH (DROPDOWN) */}
        {/* ========================================================================= */}
        <nav className="pt-3 border-t border-[#272930]">
          <button
            type="button"
        ...
        {/* ========================================================================= */}
        {/* GROUP 3: CÁ NHÂN & HỖ TRỢ (DROPDOWN) */}
        {/* ========================================================================= */}
        <nav className="pt-3 border-t border-[#272930]">
          <button
            type="button"
