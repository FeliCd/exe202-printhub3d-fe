...
export default function LockOverlayModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-xl flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#18191d] border-2 border-red-500/50 rounded-2xl shadow-2xl overflow-hidden p-6 text-center space-y-5 animate-in zoom-in-95 duration-200">
        ...
        <div>
          <span className="text-[10px] font-extrabold uppercase px-2.5 py-1 rounded bg-red-950 text-red-400 border border-red-800">
            TÀI KHOẢN BỊ TẠM KHÓA GIAO DỊCH
          </span>
          <h3 className="text-xl font-black text-white mt-2">Cảnh Báo Vi Phạm &amp; Khóa Hệ Thống</h3>
          <p className="text-xs text-slate-300 mt-2 bg-[#111215] p-3 rounded-xl border border-[#272930] text-left">
        ...
        <div className="text-xs text-[#94a3b8] space-y-1 text-left bg-brand-surface">
